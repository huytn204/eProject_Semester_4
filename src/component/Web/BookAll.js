...
const BookByRoom = () => {
    ...
    const fetchBooking = async () => {
        try {
        const response = await axios.get("http://localhost:8080/api/booking/pending");
                ...
                <div className="room-suggestions">
                    ...
                    <div className="room-card">
                        ...
                        <div className="room-info">
                            ...
                            <div className="room-price">
                                <Link variant="primary" to={`/bookingdetail/${book.id}`}>Detail</Link>
                            </div>
                        </div>
                    </div>
                    ))}
